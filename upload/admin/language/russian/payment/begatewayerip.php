...
$_['entry_encryptionkey']   = 'Ключ магазина';
...
$_['entry_expired_at'] = 'Действителен дней';
$_['entry_expired_at_help'] = 'Введите количество дней в течение которых заказ может быть оплачен';

// Error
$_['error_permission']      = 'Внимание: У вас нет прав для изменения настроек модуля оплаты!';
$_['error_companyid']       = 'Id магазина обязателен!';
$_['error_encryptionkey']    = 'Ключ магазина обязателен!';
$_['error_domain_api']    = 'Домен API обязателен!';
